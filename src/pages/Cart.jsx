...
import { updateIncrement } from '../store/CartSlice'
...
const Cart = () => {
    ...
    // console.log(price * discontP /100)
            ...
            <div className="grid md:grid-cols-3 gap-4">
                ...
                <div className="bg-gray-100 rounded-md p-4 md:sticky top-0">
                    ...
                    <ul className="text-gray-800 mt-8 space-y-4">
                        <li className="flex flex-wrap gap-4 text-base">Discount <span className="ml-auto font-bold">${discont.toFixed(2)}</span></li>
                    ...
                    <div className="mt-8 space-y-2">
                        ...
                        <Link to={'/'}className="text-sm bg-green-400 px-4 py-2.5 mt-3 block text-center w-full font-semibold text-gray-800 border border-gray-300 rounded-md">Continue Shopping  </Link>
                    </div>
                </div>
            </div>
        </div>
        :
        <h1 className='text-4xl text-center mt-12'>Cart is empty</h1>
        }
    </div>
  )
}
